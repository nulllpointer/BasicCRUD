...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2 style="color: green">${hiteshHeader}</h2>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <c:forEach var="user" items="${hitesh}">
                                ...
                                <tr>
                                    ...
                                    <td>${user.password}</td>
                                    <td><a href="user?id=${user.id}">Edit me</a></td>
                                    <td><a href="deleteuser?id=${user.id}">Delete me</a></td>
                                </tr>
                ...
                <div class="col-lg-6">
                    ...
                    <form role="form" action="/user" method="post">
                        ...
                        <div class="form-group">
                            <label>Id</label>
                            <input name="id" class="form-control" value="${currentUser.id}">
